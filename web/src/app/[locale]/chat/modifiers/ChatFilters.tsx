...
enum FilterType {
  Source = "FilterType_Source",
  KnowledgeSet = "FilterType_KnowledgeSet",
  TimeRange = "FilterType_TimeRange",
  Tag = "FilterType_Tag",
}
    ...
    <div className="w-64">
      ...
      {hasKnowledgeSets && (
        <DefaultDropdownElement
          ...
          name={t(FilterType.KnowledgeSet)}
          icon={FiBook}
    ...
    <div className="flex">
      ...
      <div className="flex ml-4">
        {((timeRange && timeRange.selectValue !== undefined) ||
          ...
          <p className="text-xs my-auto mr-1">{t("Currently_Applied")}:</p>
        )}
