...
export const Chat = ({
  ...
  const onFeedback = async (
    ...
    if (response.ok) {
      ...
      setPopup({
        message: t("Failed_Submit_Feedback", {errorMsg: errorMsg}),
        type: "error",
      });
    }
  };
                              ...
                              ? (newQuery) => {
                                  ...
                                  if (previousMessage.messageId === null) {
                                    setPopup({
                                      type: "error",
                                      message:
                                        t("Cannot_Edit_Query_Pedding_Msg"),
                                    });
                                    return;
                                  }
                                  onSubmit({
