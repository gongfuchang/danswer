    ...
    >
          ...
          <div className="overflow-y-auto dark-scrollbar flex flex-col">
            <div>
              {dedupedDocuments.length > 0 ? (
                ...
                <div className="mx-3">
                  <Text>{t("No_Documents_Found")}</Text>
                </div>
              )}
            </div>
          </div>
      ...
      <div className="text-sm mb-4 border-t border-border pt-4 overflow-y-hidden flex flex-col">
        <div className="flex border-b border-border px-3">
          <div className="flex">
            <SectionHeader name={t("Selected_Documents")} icon={FiFileText} />
              ...
              <div className="ml-2 my-auto">
                <div className="mb-2">
                  <HoverPopup
                    ...
                    popupContent={
                      <Text className="w-40">
                        {t.rich("LLM_Context_Length_Alert", { tokens: selectedDocumentTokens - maxTokens, i: (chunks) => (<i>{chunks}</i>)})}
                        <br />
                        <br />
          ...
          {selectedDocuments && selectedDocuments.length > 0 && (
            <div className="ml-auto my-auto" onClick={clearSelectedDocuments}>
              <BasicSelectable selected={false}>{t("De_Select_All")}</BasicSelectable>
            </div>
          )}
        </div>
