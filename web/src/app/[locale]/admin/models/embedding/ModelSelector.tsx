...
export function ModelOption({
  ...
  const t = useTranslations("admin_models_embedding_ModelSelector");
  const model_t = useTranslations("admin_models_embedding_embeddingModels");
  ...
  return (
    ...
    >
      ...
      <div className="text-sm mt-1 mx-1">{model_t(model.description)}</div>
      {model.link && (
        <a
          target="_blank"
          href={model.link}
