...
function Main({ ccPairId }: { ccPairId: number }) {
  ...
  const t = useTranslations("admin_connector_ccPairId_page");
  ...
  if (error || !ccPair) {
    return (
      <ErrorCallout
        errorTitle={t("Failed_Fetch_Connector_Info", {ccPairId: ccPairId})}
  ...
  return (
    ...
    <div className="text-sm mt-1">
      ...
      <div className="mt-6">
        <div className="flex">
          <Title>{t("Indexing_Attempts")}</Title>
      ...
      <div className="mt-4">
        <Title>{t("Delete_Connector_Title")}</Title>
        <Text>
            {t("Delete_Connector_Text")}
        </Text>
