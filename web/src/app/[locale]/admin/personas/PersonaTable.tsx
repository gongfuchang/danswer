...
export function PersonasTable({ personas }: { personas: Persona[] }) {
  const t = useTranslations("admin_personas_PersonaTable");
  ...
  return (
    <div>
      ...
      <Text className="my-2">
        {t("Persona_Display_Text")}
      </Text>

      <DraggableTable
        headers={[t("Name"), t("Description"), t("Built-In"), t("Is_Visible"), t("Delete")]}
        rows={finalPersonaValues.map((persona) => {
          return {
            ...
            cells: [
              ...
              persona.default_persona ? t("Yes") : t("No"),
              <div
                key="is_visible"
                onClick={async () => {
                    ...
                    <div
                      ...
                      onClick={async () => {
                        ...
                        if (response.ok) {
                          ...
                          alert(
                            t("Failed_To_Delete", {detail: await response.text()})
                          );
                        }
                      }}
                    >
