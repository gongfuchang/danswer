...
const IsVisibleSection = ({
  ...
  const t = useTranslations("admin_documents_feedback_DocumentFeedbackTable");
  return (
    <HoverPopup
      mainContent={
        document.hidden ? (
  ...
  return (
    <div>
      <Table className="overflow-visible">
        <TableHead>
          <TableRow>
            <TableHeaderCell>{t("Document_Name")}</TableHeaderCell>
            <TableHeaderCell>{t("Is_Searchable")}</TableHeaderCell>
