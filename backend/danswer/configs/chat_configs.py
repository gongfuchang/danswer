...
DISABLE_LLM_QUERY_ANSWERABILITY = os.environ.get("DISABLE_LLM_QUERY_ANSWERABILITY", "").lower() != "false"
...
HYBRID_ALPHA = max(0, min(1, float(os.environ.get("HYBRID_ALPHA") or 0.80)))
...
TITLE_CONTENT_RATIO = max(
    0, min(1, float(os.environ.get("TITLE_CONTENT_RATIO") or 0.30))
)
